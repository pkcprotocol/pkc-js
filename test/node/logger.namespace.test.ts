...
describe("normalizeLoggerNamespace", () => {
    it("renames logger namespaces to PKC naming", () => {
        expect(normalizeLoggerNamespace("plebbit-js:PlebbitRpcClient")).toBe("pkc-js:PKCRpcClient");
        expect(normalizeLoggerNamespace("plebbit-js:local-subplebbit:start")).toBe("pkc-js:local-community:start");
        expect(normalizeLoggerNamespace("plebbit-js:listSubplebbitsSync")).toBe("pkc-js:listCommunitiesSync");
