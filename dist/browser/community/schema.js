import { z } from "zod";
import { AuthorAddressSchema, ChallengeAnswerStringSchema, CidStringSchema, CreateSignerSchema, FlairSchema, JsonSignatureSchema, PKCTimestampSchema, ProtocolVersionSchema, SignerWithAddressPublicKeySchema, CommunityAddressSchema } from "../schema/schema.js";
...
export const CreateRpcCommunityFunctionArgumentSchema = CreateRemoteCommunityFunctionArgumentSchema.or(CreateNewLocalCommunityUserOptionsSchema);
export const CreateCommunityFunctionArgumentsSchema = CreateNewLocalCommunityUserOptionsSchema.or(CreateRemoteCommunityFunctionArgumentSchema);
// pkc.listCommunities()
