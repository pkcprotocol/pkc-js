...
export const CommunityEditPublicationSignedPropertyNames = remeda.keys.strict(remeda.omit(CreateCommunityEditPublicationOptionsSchema.shape, keysToOmitFromSignedPropertyNames));
const communityEditPublicationPickOptions = (remeda.mapToObj([...CommunityEditPublicationSignedPropertyNames, "signature"], (x) => [x, true]));
