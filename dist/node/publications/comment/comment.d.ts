...
export declare class Comment extends Publication implements Partial<CommentUpdateForChallengeVerification>, CommentPubsubMessagePublication, Partial<CommentIpfsWithCidPostCidDefined>, Partial<Omit<CommentUpdateType, "replies">> {
    ...
    private _stopAbortController?;
    challengeRequest?: CreateCommentOptions["challengeRequest"];
    private _communityForUpdating?;
    ...
    protected _signPublicationOptionsToPublish(cleanedPublication: unknown): Promise<CommentPubsubMessagePublication["signature"]>;
    ...
    private _copyNameResolvedFromComment;
    _resolveAuthorNamesInBackground(): void;
    _initProps(props: CommentIpfsType | CommentPubsubMessagePublication): void;
    _initCommentUpdate(props: CommentUpdateType | CommentWithinRepliesPostsPageJson, community?: Pick<CommunityIpfsType, "signature">): void;
    _updateRepliesPostsInstance(newReplies: CommentUpdateType["replies"] | CommentWithinRepliesPostsPageJson["replies"] | Pick<RepliesPagesTypeIpfs, "pageCids">, community?: Pick<CommunityIpfsType, "signature">): void;
    ...
    setCommunityAddress(newCommunityAddress: string): void;
    ...
    startCommentUpdateCommunitySubscription(): Promise<void>;
    ...
    protected _setRpcClientState(newState: Comment["clients"]["pkcRpcClients"][""]["state"]): void;
    ...
    _useUpdatePropsFromUpdatingStartedCommunityIfPossible(): void;
    _useUpdatePropsFromUpdatingCommentIfPossible(): void;
    _useUpdatingCommentFromPKC(updatingCommentInstance: Comment): void;
