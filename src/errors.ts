export enum messages {
    ...
    ERR_COMMUNITY_OPTIONS_MISSING_ADDRESS = "The options sent to plebbit.createCommunity() is missing address or signer",
    ...
    ERR_COMMUNITY_OWNER_ATTEMPTED_EDIT_NEW_ADDRESS_THAT_ALREADY_EXISTS = "Community owner attempted to edit subplebbit.address to a new address that already exists",
    ...
    ERR_GET_COMMUNITY_TIMED_OUT = "plebbit.getCommunity({address}) timed out",
    ...
    ERR_UNABLE_TO_DERIVE_PUBSUB_COMMUNITY_EDIT_PUBLICATION_FROM_JSONIFIED_COMMUNITY_EDIT = "User provided a jsonfied (cloned) CommunityEdit and we're unable to derive request.subplebbitEdit from it. This is an implementation error",
    ...
    ERR_INVALID_CREATE_COMMUNITY_ARGS_SCHEMA = "User provided invalid schema of arguments for plebbit.createCommunity",
    ...
    ERR_INVALID_CREATE_COMMUNITY_EDIT_ARGS_SCHEMA = "User provided an invalid args to plebbit.createCommunityEdit",
    ...
    ERR_INVALID_CREATE_COMMUNITY_WITH_RPC_ARGS_SCHEMA = "User provided invalid schema of arguments for plebbit.createCommunity while connected to RPC",
    ...
    ERR_THE_COMMUNITY_IPNS_RECORD_POINTS_TO_DIFFERENT_ADDRESS_THAN_WE_EXPECTED = "The subplebbit record address does not correspond to the requested subplebbit. requestedCommunity.address !== providedCommunity.address",
    ...
    ERR_COMMUNITY_EDIT_ATTEMPTED_TO_MODIFY_COMMUNITY_WITHOUT_BEING_OWNER_OR_ADMIN = "CommunityEdit attempted to modify subplebbit without being an owner or admin",
    ...
    ERR_CAN_NOT_LOAD_DB_IF_LOCAL_COMMUNITY_ALREADY_STARTED_IN_ANOTHER_PROCESS = "Can't load a local subplebbit that's already started in another process. You need to use the same PKC instance to load the subplebbit",
    ERR_CAN_NOT_EDIT_A_LOCAL_COMMUNITY_THAT_IS_ALREADY_STARTED_IN_ANOTHER_PROCESS = "Can't edit a local subplebbit that's already started in another process. You need to use the same PKC instance to edit the subplebbit",
    ...
    ERR_COMMUNITY_ALREADY_STARTED_IN_SAME_PKC_INSTANCE = "Community already started in the same PKC instance. You can check plebbit._startedCommunitys to see all started subplebbits",
