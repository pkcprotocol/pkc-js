export enum messages {
    ERR_COMMUNITY_SIGNER_NOT_DEFINED = "Subplebbit signer is not defined",
    ERR_COMMUNITY_CAN_EITHER_RUN_OR_UPDATE = "Subplebbit can either sync through .start() or update, but not both",
    ERR_PUBLICATION_MISSING_FIELD = "Publication is missing field(s)",
    ERR_COMMUNITY_MISSING_FIELD = "Subplebbit is missing field needed for publishing",
    ERR_COMMUNITY_OPTIONS_MISSING_ADDRESS = "The options sent to plebbit.createSubplebbit() is missing address or signer",
    ERR_INVALID_COMMUNITY_ADDRESS_SCHEMA = "Subplebbit address is incorrect. Address should be either a domain or IPNS",
    ...
    ERR_COMMUNITY_OWNER_ATTEMPTED_EDIT_NEW_ADDRESS_THAT_ALREADY_EXISTS = "Subplebbit owner attempted to edit subplebbit.address to a new address that already exists",
    ...
    ERR_NEED_TO_STOP_UPDATING_COMMUNITY_BEFORE_STARTING = "You need to stop updating the subplebbit before starting it",
    ...
    ERR_GET_COMMUNITY_TIMED_OUT = "plebbit.getSubplebbit({address}) timed out",
    ...
    // Plebbit errors
    ERR_CALLED_COMMUNITY_STOP_WITHOUT_UPDATE = "subplebbit.stop() called without calling update() first",
    ERR_PKC_MISSING_NATIVE_FUNCTIONS = "missing nativeFunctions required to create a subplebbit",
    ERR_CAN_NOT_RUN_A_COMMUNITY_WITH_NO_IPFS_NODE = "Can't run a subplebbit with plebbit.ipfsHttpClientOptions undefined",
    ERR_PKC_OPTION_NOT_ACCEPTED = "Option is not accepted on Plebbit constructor",
    ...
    ERR_CAN_NOT_CREATE_A_LOCAL_COMMUNITY = "Can't create a new local sub with the provided arguments",
    ERR_COMMUNITY_ADDRESS_IS_PROVIDED_AS_NULL_OR_UNDEFINED = "User provided options.address in createSubplebbit that is either undefined or null",
    ...
    ERR_UNABLE_TO_DERIVE_PUBSUB_COMMUNITY_EDIT_PUBLICATION_FROM_JSONIFIED_COMMUNITY_EDIT = "User provided a jsonfied (cloned) SubplebbitEdit and we're unable to derive request.subplebbitEdit from it. This is an implementation error",
    ERR_PKC_SQLITE_LONG_TERM_STORAGE_KEYV_ERROR = "Error in Keyv SQLITE adapter",
    ERR_PKC_IS_DESTROYED = "Plebbit instance has been destroyed. Create a new instance.",
    // Fetch errors
    ...
    ERR_FAILED_TO_FETCH_COMMUNITY_FROM_GATEWAYS = "Failed to fetch Subplebbit IPNS record from gateway(s)",
    ...
    ERR_COMMUNITY_HAS_NO_POST_UPDATES = "Subplebbit has no postUpdates field and therefore can't fetch a commentUpdate",
    ...
    ERR_COMMUNITY_NAME_HAS_CAPITAL_LETTER = "Domain address has an uppercase letter. Subplebbit domain address should be lowercase",
    ...
    ERR_GATEWAY_ABORTING_LOADING_COMMUNITY_BECAUSE_SAME_INVALID_COMMUNITY_RECORD = "Aborted the gateway request to load subplebbit record because it will give us an invalid record we already processed and validated before",
    ERR_GATEWAY_ABORTING_LOADING_COMMUNITY_BECAUSE_SAME_UPDATE_CID = "Aborted the gateway request to load subplebbit record because it will give us the same record we already have",
    ERR_GATEWAY_ABORTING_LOADING_COMMUNITY_BECAUSE_WE_ALREADY_LOADED_THIS_RECORD = "Aborted the gateway request to load subplebbit record because we already loaded this record before",
    ERR_GATEWAY_PROVIDED_INCORRECT_X_IPFS_ROOTS = "Gateway provided an x-ipfs-roots that doesn't correspond to body",
    ERR_REMOTE_COMMUNITY_RECEIVED_ALREADY_PROCCESSED_RECORD = "We loaded a subplebbit record but it's a record we already consumed before",
    ...
    ERR_INVALID_COMMUNITY_IPFS_SCHEMA = "The loaded Subplebbit record has an invalid schema",
    ...
    ERR_INVALID_RPC_LOCAL_COMMUNITY_UPDATE_SCHEMA = "RPC server has transmitted a local subplebbit update result with invalid schema",
    ...
    ERR_INVALID_RPC_ENCODED_CHALLENGE_REQUEST_WITH_COMMUNITY_AUTHOR_PUBSUB_MSG_SCHEMA = "RPC server transmitted an invalid challenge request schema for RpcLocalSubplebbit",
    ERR_INVALID_RPC_REMOTE_COMMUNITY_SCHEMA = "Invalid schema of remote subplebbit transmitted by RPC",
    ...
    ERR_LOCAL_COMMUNITY_PRODUCED_INVALID_SCHEMA = "Local subplebbit produced a subplebbit record with invalid schema",
    ...
    ERR_INVALID_CREATE_COMMUNITY_ARGS_SCHEMA = "User provided invalid schema of arguments for plebbit.createSubplebbit",
    ...
    ERR_INVALID_CREATE_REMOTE_COMMUNITY_ARGS_SCHEMA = "User provided an invalid remote subplebbit schema",
    ERR_INVALID_CREATE_COMMUNITY_EDIT_ARGS_SCHEMA = "User provided an invalid args to plebbit.createSubplebbitEdit",
    ...
    ERR_INVALID_CREATE_NEW_LOCAL_COMMUNITY_USER_OPTIONS = "User provided arguments to create a local sub with invalid schema",
    ...
    ERR_INVALID_COMMUNITY_EDIT_CHALLENGE_REQUEST_TO_ENCRYPT_SCHEMA = "RPC client sent an invalid schema for challenge request with subplebbitEdit",
    ERR_COMMUNITY_EDIT_OPTIONS_SCHEMA = "User sent a subplebbit edit options with invalid schema",
    ERR_INVALID_CHALLENGE_ANSWERS = "User sent challenge answers with invalid schema",
    ERR_INVALID_CREATE_PKC_WS_SERVER_OPTIONS_SCHEMA = "Invalid create arguments for Plebbit WS RPC server",
    ERR_INVALID_CREATE_PKC_ARGS_SCHEMA = "User sent arguments with invalid schema in an attempt to create a Plebbit instance",
    ERR_INVALID_CREATE_COMMUNITY_WITH_RPC_ARGS_SCHEMA = "User provided invalid schema of arguments for plebbit.createSubplebbit while connected to RPC",
    ...
    ERR_COMMUNITY_HAS_NO_INTERNAL_STATE = "The subplebbit has no internal state. This should never happen. Please report this bug.",
    ...
    ERR_THE_COMMUNITY_IPNS_RECORD_POINTS_TO_DIFFERENT_ADDRESS_THAN_WE_EXPECTED = "The subplebbit record address does not correspond to the requested subplebbit. requestedSubplebbit.address !== providedSubplebbit.address",
    ...
    ERR_COMMUNITY_IPNS_NAME_DOES_NOT_MATCH_SIGNATURE_PUBLIC_KEY = "The IPNS name of subplebbit doesn't match subplebbit.signature.publicKey",
    ERR_COMMENT_SHOULD_BE_THE_LATEST_EDIT = "comment.content is not set to the latest comment.authorEdit.content",
    ERR_COMMENT_UPDATE_IS_NOT_SIGNED_BY_COMMUNITY = "Comment update is not signed by the subplebbit",
    ...
    ERR_CHALLENGE_MSG_SIGNER_IS_NOT_COMMUNITY = "The signer of challenge pubsub message is not the subplebbit",
    ERR_CHALLENGE_VERIFICATION_MSG_SIGNER_IS_NOT_COMMUNITY = "The signer of challenge verification pubsub message is not the subplebbit",
    ...
    ERR_LOCAL_COMMUNITY_PRODUCED_INVALID_SIGNATURE = "Local subplebbit produced a new record with invalid signature",
    ERR_COMMUNITY_POSTS_INVALID = "subplebbit.posts signature is invalid",
    ...
    ERR_COMMUNITY_EDIT_HAS_RESERVED_FIELD = "SubplebbitEdit record includes a reserved field",
    ERR_COMMUNITY_SIGNATURE_IS_INVALID = "Subplebbit signature is invalid",
    ERR_COMMUNITY_RECORD_INCLUDES_RESERVED_FIELD = "The SubplebbitIpfs record includes a reserved field",
    ERR_FAILED_TO_RESOLVE_COMMUNITY_DOMAIN = "Failed to resolve the subplebbit domain address to use for verification",
    ...
    ERR_COMMUNITY_RECORD_INCLUDES_FIELD_NOT_IN_SIGNED_PROPERTY_NAMES = "SubplebbitIpfs record includes a field not included in signature.signedPropertyNames",
    ...
    ERR_COMMUNITY_EDIT_RECORD_INCLUDES_FIELD_NOT_IN_SIGNED_PROPERTY_NAMES = "SubplebbitEditPubsubPublication includes a field that's not in signature.signedPropertyNames",
    ERR_COMMUNITY_CHANGED_COMMENT_PUBSUB_PUBLICATION_PROPS = "The sub changed CommentPubsubMessagePublication props in decryptedChallengeVerification.comment",
    ERR_COMMUNITY_SENT_CHALLENGE_VERIFICATION_WITH_INVALID_COMMENT = "The subplebbit sent an invalid decryptedChallengeVerification.comment",
    ERR_COMMUNITY_SENT_CHALLENGE_VERIFICATION_WITH_INVALID_COMMENTUPDATE = "The subplebbit sent an invalid decryptedChallengeVerification.commentUpdate",
    ERR_COMMUNITY_SENT_CHALLENGE_VERIFICATION_WITH_INVALID_CID = "The sub sent decryptedChallengeVerification with commentUpdate.cid that does not correspond to commentIpfs",
    ...
    // getPage errors
    ERR_COMMENT_IN_PAGE_BELONG_TO_DIFFERENT_COMMUNITY = "Comment in page should be under the same subplebbit",
    ...
    ERR_PUBLICATION_PARENT_DOES_NOT_EXIST_IN_COMMUNITY = "The parent of this publication does not exist within the subplebbit's records",
    ...
    ERR_PUBLICATION_INVALID_COMMUNITY_ADDRESS = "The subplebbitAddress field of publication is not the same as the subplebbit being published to",
    ...
    ERR_COMMUNITY_FAILED_TO_DECRYPT_PUBSUB_MSG = "Subplebbit failed to decrypt the pubsub message",
    ...
    ERR_COMMUNITY_EDIT_ATTEMPTED_TO_MODIFY_OWNER_EXCLUSIVE_PROPS = "SubplebbitEdit attempted to modify props meant only for the owner to edit",
    ERR_COMMUNITY_EDIT_ATTEMPTED_TO_MODIFY_COMMUNITY_WITHOUT_BEING_OWNER_OR_ADMIN = "SubplebbitEdit attempted to modify subplebbit without being an owner or admin",
    ERR_COMMUNITY_EDIT_ATTEMPTED_TO_NON_PUBLIC_PROPS = "SubplebbitEdit attempted to modify non public props or non existent. SubplebbitEdit is only allowed to edit props from SubplebbitIpfs schema",
    ...
    ERR_DOMAIN_COMMUNITY_ADDRESS_TXT_RECORD_POINT_TO_DIFFERENT_ADDRESS = "subplebbit-address text record of domain is pointing to a different address than subplebbit.signer.address",
    ERR_RESOLVED_TEXT_RECORD_TO_NON_IPNS = "Resolved the text record value to a string that is non IPNS",
    ERR_COMMUNITY_DOMAIN_HAS_NO_TEXT_RECORD = "Domain resolver did not find the text record subplebbit-address",
    ...
    // Local sub errors
    ERR_LOCAL_COMMUNITY_HAS_NO_SIGNER_IN_INTERNAL_STATE = "subplebbit.signer needs to be defined before proceeding",
    ERR_COMMUNITY_STATE_LOCKED = "The internal state of the subplebbit in DB is locked",
    ERR_COMMUNITY_CREATION_LOCKED = "Subplebbit creation is locked",
    ERR_COMMUNITY_ALREADY_STARTED = "Subplebbit already started",
    ERR_FAILED_TO_IMPORT_IPFS_KEY = "Subplebbit failed to import IPFS key",
    ERR_LOCAL_COMMUNITY_PRODUCED_INVALID_RECORD = "The local subplebbit has produced a new IPNS record with invalid signature. This is a crticial error",
    ...
    ERR_LOCAL_COMMUNITY_RECORD_TOO_LARGE = "Local subplebbit has produced a record that is too large. This is a critical error and a bug in plebbit-js",
    ERR_CAN_NOT_LOAD_DB_IF_LOCAL_COMMUNITY_ALREADY_STARTED_IN_ANOTHER_PROCESS = "Can't load a local subplebbit that's already started in another process. You need to use the same Plebbit instance to load the subplebbit",
    ERR_CAN_NOT_EDIT_A_LOCAL_COMMUNITY_THAT_IS_ALREADY_STARTED_IN_ANOTHER_PROCESS = "Can't edit a local subplebbit that's already started in another process. You need to use the same Plebbit instance to edit the subplebbit",
    CAN_NOT_LOAD_LOCAL_COMMUNITY_IF_DB_DOES_NOT_EXIST = "Can't load the local sub because its DB does not exist in dataPath",
    ERR_COMMUNITY_START_FAILED_UNKNOWN_ERROR = "Subplebbit start failed with unknown error",
    ERR_COMMUNITY_ALREADY_STARTED_IN_SAME_PKC_INSTANCE = "Subplebbit already started in the same Plebbit instance. You can check plebbit._startedSubplebbits to see all started subplebbits",
    ...
    ERR_RPC_CLIENT_ATTEMPTING_TO_START_A_REMOTE_COMMUNITY = "Attempting to start a subplebbit that is not local",
    ERR_RPC_CLIENT_TRYING_TO_STOP_COMMUNITY_THAT_IS_NOT_RUNNING = "RPC client is attempting to stop a local sub that is not running",
    ERR_RPC_CLIENT_TRYING_TO_STOP_REMOTE_COMMUNITY = "RPC client is attempting to stop a remote sub",
    ERR_RPC_CLIENT_TRYING_TO_EDIT_REMOTE_COMMUNITY = "RPC client is attempting to edit remote sub",
    ERR_RPC_CLIENT_TRYING_TO_DELETE_REMOTE_COMMUNITY = "RPC client is attempting to delete remote sub",
