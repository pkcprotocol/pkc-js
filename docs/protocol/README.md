...
| [author-communities.md](author-communities.md) | **Superseded in part, paused** (issue #31, blocked on crossposts #32). Profiles as delegated communities; `AuthorCommunityIpfs`, the envelope, and the sync pair are not to be implemented. Read the status banner first |
